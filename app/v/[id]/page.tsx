...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://bokepcindoabg.pages.dev/v/${file.filecode}`
            }  
        }
        }

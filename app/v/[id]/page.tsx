...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepcindoabg.pages.dev/v/${file.filecode}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokepcindoabg.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://bokepcindoabg.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
